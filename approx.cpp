...
void approx::writeGSR(std::string name, bool suf){
	std::string suffix = "";
	std::string suffix2 = "";
	...
	if (!suf)
        ...
        for(int i=0; i!=Delta2GSR.size(); i++){
                myfile << ((*ks)[i]) << "  " << Delta2GSR[i] << std::endl;//"  " << Delta2NLA[i] << std::endl;//"  " << B[i] << "  " << cosphi[i] << "  " << deltaI0[i] << "  " << deltaI1[i] <<  std::endl;
        }   
...
void approx::writeNLA(std::string name, bool suf){
	std::string suffix = "";
	std::string suffix2 = "";
	...
	if (!suf)
        ...
        for(int i=0; i!=Delta2GSR.size(); i++){
                myfile << ((*ks)[i]) << "  " << Delta2NLA[i] << std::endl;//"  " << Delta2NLA[i] << std::endl;//"  " << B[i] << "  " << cosphi[i] << "  " << deltaI0[i] << "  " << deltaI1[i] <<  std::endl;
        }   
